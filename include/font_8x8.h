...
// 8x8 ASCII font table, VGA 8x8 (column-major format)
// font_8x8[ch - 0x20][col], col 0 = leftmost column
...
static const uint8_t font_8x8[][8] = {
    ...
    {0x1C, 0x3E, 0x63, 0x49, 0x63, 0x3E, 0x1C, 0x00},  // 0x30 '0'
    {0x00, 0x40, 0x42, 0x7F, 0x7F, 0x40, 0x40, 0x00},  // 0x31 '1'
    {0x42, 0x63, 0x71, 0x59, 0x49, 0x6F, 0x66, 0x00},  // 0x32 '2'
    {0x22, 0x63, 0x49, 0x49, 0x49, 0x7F, 0x36, 0x00},  // 0x33 '3'
    {0x18, 0x1C, 0x16, 0x53, 0x7F, 0x7F, 0x50, 0x00},  // 0x34 '4'
    {0x2F, 0x6F, 0x49, 0x49, 0x49, 0x79, 0x31, 0x00},  // 0x35 '5'
    {0x3C, 0x7E, 0x4B, 0x49, 0x49, 0x78, 0x30, 0x00},  // 0x36 '6'
    ...
    {0x1C, 0x3E, 0x63, 0x41, 0x51, 0x33, 0x72, 0x00},  // 0x47 'G'
    ...
    {0x3E, 0x7F, 0x41, 0x41, 0xE1, 0xFF, 0xBE, 0x00},  // 0x51 'Q'
    {0x41, 0x7F, 0x7F, 0x09, 0x19, 0x7F, 0x66, 0x00},  // 0x52 'R'
    {0x00, 0x22, 0x67, 0x4D, 0x59, 0x73, 0x22, 0x00},  // 0x53 'S'
    ...
    {0x3F, 0x7F, 0x60, 0x38, 0x60, 0x7F, 0x3F, 0x00},  // 0x57 'W'
    ...
    {0x00, 0x60, 0xE0, 0x80, 0x80, 0xFD, 0x7D, 0x00},  // 0x6A 'j'
    {0x41, 0x7F, 0x7F, 0x10, 0x38, 0x6C, 0x44, 0x00},  // 0x6B 'k'
    {0x00, 0x00, 0x41, 0x7F, 0x7F, 0x40, 0x00, 0x00},  // 0x6C 'l'
    {0x7C, 0x7C, 0x0C, 0x78, 0x0C, 0x7C, 0x78, 0x00},  // 0x6D 'm'
    ...
    {0x44, 0x7C, 0x78, 0x4C, 0x04, 0x0C, 0x08, 0x00},  // 0x72 'r'
    ...
    {0x3C, 0x7C, 0x60, 0x38, 0x60, 0x7C, 0x3C, 0x00},  // 0x77 'w'
    {0x44, 0x6C, 0x38, 0x10, 0x38, 0x6C, 0x44, 0x00},  // 0x78 'x'
    {0x9C, 0xBC, 0xA0, 0xA0, 0xA0, 0xFC, 0x7C, 0x00},  // 0x79 'y'
    {0x00, 0x4C, 0x64, 0x74, 0x5C, 0x4C, 0x64, 0x00},  // 0x7A 'z'
